...
function ipsetchange() {
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "clash_ipsetproxychange.sh", "params":[], "fields": dbus_post};
	$.ajax({
		type: "POST",
		cache:false,
		url: "/_api/",
...
function ipsetarroundchange() {
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "clash_ipsetproxyarroundchange.sh", "params":[], "fields": dbus_post};
	$.ajax({
		type: "POST",
		cache:false,
		url: "/_api/",
											...
											<div id="merlinclash-content-overview">												
												...
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_switch_table">
													...
													<tr>
														...
														<tr>
															<th id="btn-selectlist" class="btn btn-primary"><a class="hintstyle" href="javascript:void(0);" onclick="openmcHint(27)">重建下拉列表</a></th>
																<td colspan="2">
														...
														<tr>
															<th id="btn-iptquicklyrestart" class="btn btn-primary"><a class="hintstyle" href="javascript:void(0);" onclick="openmcHint(25)">重建IPTABLES</a></th>
																<td colspan="2">
																	<div class="merlinclash-btn-iptquicklyrestart">																	
																		<a type="button" style="vertical-align: middle; cursor:pointer;" class="ss_btn" id="iptquicklyrestart" onclick="iptquickly_restart()">&nbsp;&nbsp;重建IPTABLES&nbsp;&nbsp;</a>												
																	</div>
																</td>
														</tr>
														<tr>
															<th id="btn-quicklyrestart" class="btn btn-primary"><a class="hintstyle" href="javascript:void(0);" onclick="openmcHint(7)">快速重启</a></th>
																<td colspan="2">
																	<div class="merlinclash-btn-quicklyrestart">																	
																		<a type="button" style="vertical-align: middle; cursor:pointer;" class="ss_btn" id="quicklyrestart" onclick="quickly_restart()">&nbsp;&nbsp;快速重启&nbsp;&nbsp;</a>														
																	</div>
																</td>
														</tr>
										...
										<div id="tablet_2" style="display: none;">
											...
											<div id="clash_ipsetproxy_area">										
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_ipset_table">
													<thead>
													<tr>
														<td colspan="2">IPtables转发白名单 - 强制转发到Clash -- <em style="color: gold;">【编辑完成后点击“修改提交”保存，下次启动后生效】|【开启编辑：<input id="merlinclash_ipsetedit_check" class="barcodeSavePrint1" type="checkbox" name="ipsetedit_check" >】</em></td>
													</tr>
													<script>
														$(function () {
												...
												<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_ipsetproxy_content_table">
													<tr id="ipsetproxy_edit_tr">
														<th>IP/域名集编辑 | 一行一个，可以带掩码声明</th>
															<td>
																<input class="ss_btn" type="button" onclick="ipsetchange()" value="修改提交">
											...
											<div id="clash_ipsetproxyarround_area">										
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_ipsetarround_table">
													<thead>
													<tr>
														<td colspan="2">IPtables转发黑名单 - 强制绕行Clash -- <em style="color: gold;">【编辑完成后点击“修改提交”保存，下次启动后生效】|【开启编辑：<input id="merlinclash_ipsetarroundedit_check" class="barcodeSavePrint2" type="checkbox" name="ipsetarroundedit_check" >】</em></td>
													</tr>
													<script>
														$(function () {
												...
												<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="merlinclash_ipsetproxyarround_content_table">
													<tr id="ipsetproxyarround_edit_tr">
														<th>IP/域名集编辑 | 一行一个，可以带掩码声明</th>
															<td>
																<input class="ss_btn" type="button" onclick="ipsetarroundchange()" value="修改提交">
											...
											<div id="tproxy" style="margin:-1px 0px 0px 0px;">
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >																							
													...
													<tr id="clash_ipv6" style="height: 30px;" >
														<th>IPv6代理 <a class="hintstyle" href="javascript:void(0);" onclick="openmcHint(24)"><em style="color: gold;"> - 不兼容护网大师</em></a></th>
															<td colspan="2">
																<div class="switch_field" style="display:table-cell;float: left;">
